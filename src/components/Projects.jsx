...
const Projects = () => {
    ...
    return (
        <div className='mt-10' id='projects'>
            ...
            <div data-aos='zoom-in-left' className="px-4 py-2 mx-auto bg-white border-2 rounded-lg shadow-2xl lg:w-5/6 card-container h-3/5">
                <div className="flex flex-col card-body">
                    <h1 className='mb-2 text-2xl font-bold text-left font-Dosis'>Personal Development Tracker App</h1>
                    <p className='mb-4 text-sm font-semibold text-gray-500'>An application to track your goals, achievements, lesson learned and other stuff that makes you aware of your personal development.</p>
            ...
            <div data-aos='zoom-in-left' className="px-4 py-2 mx-auto bg-white border-2 rounded-lg shadow-2xl lg:w-5/6 card-container h-3/5">
                <div className="flex flex-col card-body">
                    <h1 className='mb-2 text-2xl font-bold text-left font-Dosis'>Tasty Food Search App</h1>
                    <p className='mb-4 text-sm font-semibold text-gray-500'>An application where you can search any food that you like and find out the recipe and instructions on how to cook it.</p>
                </div>
                <div className="bg-red-200 bg-center card-header">
            ...
            <div data-aos='zoom-in-left' className="px-4 py-2 mx-auto bg-white border-2 rounded-lg shadow-2xl lg:w-5/6 card-container h-3/5">
                <div className="flex flex-col card-body">
                    <h1 className='mb-2 text-2xl font-bold text-left font-Dosis'>Trivia Quiz App</h1>
                    <p className='mb-4 text-sm font-semibold text-gray-500'>An application where you can take a quiz, learn facts in different categories and can select level of difficulty.</p>
                </div>
                <div className="bg-red-200 bg-center card-header">
            ...
            <div data-aos='zoom-in-left' className="px-4 py-2 mx-auto bg-white border-2 rounded-lg shadow-2xl lg:w-5/6 card-container h-3/5">
                <div className="flex flex-col card-body">
                    <h1 className='mb-2 text-2xl font-bold text-left font-Dosis'>Raboy's E-Shop</h1>
                    <p className='mb-4 text-sm font-semibold text-gray-500'>An E-Commerce web application where you can add items to the cart and has a checkout functionality using Paypal.</p>
                </div>
                <div className="bg-red-200 bg-center card-header">
                    <img src={eshop} alt="" className='w-full h-60'/>
                </div>
                <div className="flex p-2 mt-2 space-x-1 font-semibold text-gray-700 card-body">
                    <p className='px-1 py-1 bg-gray-300 rounded-md'>React</p>
                    <p className='px-1 py-1 bg-gray-300 rounded-md'>Redux</p>
