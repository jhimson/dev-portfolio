...
const Header = () => {
    ...
    return (
        <div className='flex flex-col' style={{backgroundColor: '#091c29'}}>
            <div className="flex flex-col py-8 lg:flex-row-reverse">
                <div className={`lg:ml-72 ${animated ? "" : 'translate-y-10 opacity-0'} transform transition duration-2000 ease-in-out`}>
                    <LazyLoadImage src={DevImage} effect={"opacity"} className='rounded-lg opacity-100 lg:w-4/5'/>
                </div>
